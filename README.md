...
* See the [System requirements](https://help.syncfusion.com/document-processing/system-requirements) for detailed platform requirements.
...
Navigate to the project’s root directory to run the application correctly.
